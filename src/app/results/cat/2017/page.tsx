...
export default function Cat2017ResultsPage() {
   const [currentImageIndex, setCurrentImageIndex] = useState<number | null>(null);
  const totalImages = 5; // Update this based on your actual number of images
  ...
  <div className="grid grid-cols-2 md:grid-cols-2 gap-6">
    {[1, 2, 3, 4, 5].map((item,index) => (
      ...
      >
        <Image
          src={`/assets/our-results/cat/cat17/cat${item}.png`}
     ...
     {currentImageIndex !== null && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 backdrop-blur-sm">
          ...
          <div className="relative w-full h-full max-w-6xl max-h-[90vh] flex items-center justify-center p-4">
            <Image
              src={`/assets/our-results/cat/cat17/cat${currentImageIndex + 1}.png`}
